package com.example.elice.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.example.elice.services.*.*(..))")
    ...
    @Around("@annotation(com.example.elice.interfaces.LogAspect)")
    ...
    @AfterThrowing(value = "execution(* com.example.elice.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.example.elice.services.*.*(..))",returning = "retVal")
